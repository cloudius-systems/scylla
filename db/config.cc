...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , tablets_initial_scale_factor(this, "tablets_initial_scale_factor", value_status::Used, 10,
         "Minimum average number of tablet replicas per shard per table. Suppressed by tablet hints in table's schema: min_per_shard_tablet_count and min_tablet_count")
